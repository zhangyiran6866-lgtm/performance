      ...
      <div class="col-span-9 bg-white rounded-[32px] border border-slate-200 shadow-sm flex flex-col">
        <template v-if="selectedEmp">
          ...
          <div class="px-8 py-3 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between shrink-0">
            <div class="flex items-center gap-5">
              <div class="relative">
                ...
                <div class="absolute -right-1 -bottom-1 bg-emerald-500 text-white rounded-full p-1 border-2 border-white shadow-sm flex items-center justify-center">
                   <el-icon :size="10"><CheckCircle2 /></el-icon>
                </div>
              </div>
              <div>
                <div class="flex items-center gap-3 mb-1">
                   <h4 class="text-2xl font-black text-slate-900 tracking-tight">{{ selectedEmp.name }}</h4>
                   <el-tag effect="plain" type="info" class="font-bold border-slate-200 text-slate-500">
            ...
            <div class="flex items-center gap-3">
              ...
              <el-button @click="" :disabled="props.isLocked">
                 <el-icon class="mr-2"><History /></el-icon>
                 查看历史评价
              </el-button>
              <el-button type="primary" :disabled="props.isLocked">
                ...
                <div class="p-4 md:p-5">
                  <div class="flex flex-col md:flex-row gap-5 items-start">
                    ...
                    <div class="flex-1 space-y-3">
                       <div class="flex items-center gap-3">
                          ...
                          <el-tag size="small" effect="light" type="primary" class="font-bold border-none">{{ ind.nature }}</el-tag>
                       </div>
                         ...
                         <div class="bg-slate-50/80 rounded-2xl border border-slate-200 overflow-hidden relative group/input">
                            <div class="px-5 py-2 border-b border-slate-200/50 flex items-center justify-between">
                             ...
                             <el-tooltip
                               ...
                               placement="top"
                             >
                               <el-icon class="h-4 w-4 text-slate-300 hover:text-slate-500 cursor-help"><Info /></el-icon>
                             </el-tooltip>
                            </div>
                  ...
                  <div class="mt-3 pt-3 border-t border-slate-50">
                     <div class="flex items-center gap-2 mb-2">
                        <el-icon class="text-slate-400"><MessageSquare /></el-icon>
          ...
          <div class="px-8 py-5 border-t border-slate-100 bg-white shrink-0 flex items-center justify-end">
             <div class="flex items-center gap-4">
                <el-button link class="text-slate-500 font-bold" @click="selectedEmpId = ''">取消打分项</el-button>
                <el-button type="primary" size="large" class="custom-submit-button" :disabled="props.isLocked">
                   确认并封存本条打分项
                   <el-icon class="ml-2"><ChevronRight /></el-icon>
                </el-button>
             </div>
          </div>
        </template>
        <template v-else>
           <div class="flex-1 flex flex-col items-center justify-center text-slate-300">
              <div class="w-24 h-24 bg-slate-50 rounded-full flex items-center justify-center mb-6">
                <el-icon :size="48" class="opacity-20"><User /></el-icon>
              </div>
